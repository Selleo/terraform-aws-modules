...
| [aws_efs_mount_target.targets](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/efs_mount_target) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_backup"></a> [backup](#input\_backup) | Toggle backup on/off | `bool` | `false` | no |
...
| <a name="input_name"></a> [name](#input\_name) | Volume name (creation\_token) | `string` | n/a | yes |
| <a name="input_vpc"></a> [vpc](#input\_vpc) | VPC that storage is located | <pre>object({<br>    id          = string<br>    subnets     = list(string)<br>    cidr_blocks = list(string)<br>  })</pre> | n/a | yes |
